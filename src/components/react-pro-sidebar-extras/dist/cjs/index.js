...
const AutoSubMenu = (_a) => {
    var { data } = _a; __rest(_a, ["data"]);
    if (data) {
        if (data === null || data === void 0 ? void 0 : data.children) {
            return (React.createElement(reactProSidebar.SubMenu, { title: data.title, icon: data === null || data === void 0 ? void 0 : data.icon }, data.children.map(function (child, index) {
                return React.createElement(AutoSubMenu, { key: index, data: child });
            })));
        }
    }
    if (data === null || data === void 0 ? void 0 : data.linkComponent) {
        return React.createElement(reactProSidebar.MenuItem, null, data.linkComponent);
    }
    if (data === null || data === void 0 ? void 0 : data.link) {
        return (React.createElement(reactProSidebar.MenuItem, { icon: data === null || data === void 0 ? void 0 : data.icon },
            React.createElement("a", { href: data.link }, data === null || data === void 0 ? void 0 : data.title)));
    }
    return React.createElement(reactProSidebar.MenuItem, null, data === null || data === void 0 ? void 0 : data.title);
};

exports.AutoSubMenu = AutoSubMenu;
